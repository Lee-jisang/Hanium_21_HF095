...
- 처음 진행하는 팀프로젝트 였습니다. 웹개발을 잘 할 수 있을지에 대한 막연한 두려움이 있었지만 막상 해보니까 물론어려웠지만 하나하나 해결해가며 결국 사이트를 만들 수 있었습니다.
저는 프론트엔드를 담당했으며 웹에 대한 전반적인 이해와 원리를 이해하는 저의 첫걸음이 담긴 프로젝트입니다.
